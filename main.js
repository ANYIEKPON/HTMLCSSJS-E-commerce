...
cartShopBox.getElementsByClassName('cart-remove')[0].addEventListener('click', removeButton);
...
const ready = () => {
    ...
    // Add to Cart
    let addcart = document.getElementsByClassName("shop-cart");
